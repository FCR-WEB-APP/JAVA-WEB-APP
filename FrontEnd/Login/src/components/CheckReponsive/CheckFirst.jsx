...
function CheckFirst({loggedInUser}) {
  ...
  >
    ...
    <Box className="bg-white p-4 rounded-lg shadow-sm">
      <Box className="flex flex-wrap items-center space-x-4 gap-4">
        ...
        >
          <MenuItem value="Planning A">In-Progress</MenuItem>
          <MenuItem value="Planning B">Completed</MenuItem>
        </TextField>
        <Button
          variant="contained"
        ...
        <TextField
          ...
          sx={{ backgroundColor: "white" }}
        >
          <MenuItem value="User A">Send to Head-Of-FCR</MenuItem>
        </TextField>
    ...
    {isAssignmentExpanded && (
      <Box className="mt-4">
        <FormControl component="fieldset">
          ...
          <RadioGroup value={selectedReviewer} onChange={handleReviewerChange}>
    ...
    {isFieldWorkStageExpanded && (
      <Box className="mt-4">
        <TextField
          ...
          sx={{ backgroundColor: "white" }}
        >
          <MenuItem value="FieldWork in Progress">FieldWork in Progress</MenuItem>
